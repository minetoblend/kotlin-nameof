...
import com.osucad.nameof.BuildConfig.ANNOTATIONS_LIBRARY_COORDINATES
...
class NameOfGradlePlugin : KotlinCompilerPluginSupportPlugin {
    override fun apply(target: Project) {
        target.extensions.create("nameofPlugin", NameOfGradleExtension::class.java)
    }
    ...
    override fun applyToCompilation(
        ...
        return project.provider {
            val extension = project.extensions.getByType(NameOfGradleExtension::class.java)
